...
export const fields = [
  ...
  { id: 'cancha-5', name: 'Cancha Especial', description: 'Cancha especial a precio preferente, perfecta para entrenar o jugar entre semana.', image: '/images/fields/cancha-5.jpg', imageAlt: 'Cancha Especial de fútbol 5v5 en Bodegol', price: '$500 MXN / hora', priceNote: 'Tarifa especial', featured: false, ...baseSpecs },
]

...
export default function TorneoVeteranosPage() {
  return (
    <>
      <SEO
        title="Torneo de Veteranos 35+ en Mérida"
        description="Inscripciones abiertas al Torneo de Veteranos 35+ de fútbol 5 vs 5 en Mérida. Inicia en septiembre. Inscripción de $3,000 por equipo. Solicita información por WhatsApp."
      ...
      <div className="pt-[var(--nav-height)]">
        <section className="relative overflow-hidden border-b border-line bg-background py-14 sm:py-20" aria-labelledby="torneo-title">
          ...
          <div className="site-container relative grid items-center gap-10 lg:grid-cols-[1.1fr_.9fr]">
            <div>
              <p className="t-label mb-4 text-primary">Inscripciones abiertas · Mérida, Yucatán</p>
              <h1 id="torneo-title" className="t-hero-title text-white">Torneo de Veteranos 35+</h1>
              <p className="mt-5 max-w-2xl font-ui text-lg leading-relaxed text-content-secondary">
                Forma tu equipo para competir en nuestro torneo de fútbol 5 vs 5. Iniciamos en septiembre y la inscripción es de <strong className="text-white">$3,000 por equipo</strong>.
              </p>
            ...
            <img src="/images/promotions/torneo-veteranos-35.jpg" alt="Convocatoria del Torneo de Veteranos 35+ en Bodegol" width="1600" height="900" className="w-full rounded-2xl border border-primary/30 shadow-card-lg" />
          </div>
        </section>
